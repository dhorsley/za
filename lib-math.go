...
func buildMathLib() {
    ...
    stdlib["e"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
    ...
    stdlib["pi"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
    ...
    stdlib["phi"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
    ...
    stdlib["ln2"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
    ...
    stdlib["ln10"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
    ...
    stdlib["numcomma"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
    ...
    stdlib["ln"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("ln", args, 1, "1", "number"); !ok {
            return nil, err
        }
    ...
    stdlib["log10"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("log10", args, 3, "1", "number"); !ok {
            return nil, err
        }
        var n float64
        switch args[0].(type) {
    ...
    stdlib["log2"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("log2", args, 3, "1", "number"); !ok {
            return nil, err
        }
        var n float64
        switch args[0].(type) {
    ...
    stdlib["logn"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
    ...
    stdlib["deg2rad"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("deg2rad", args, 1, "1", "number"); !ok {
            return nil, err
        }
        var radians float64
        switch args[0].(type) {
    ...
    stdlib["rad2deg"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("rad2deg", args, 1, "1", "number"); !ok {
            return nil, err
        }
        var degrees float64
        switch args[0].(type) {
    ...
    stdlib["pow"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("pow", args, 4,
            "2", "int", "int",
            "2", "int", "float64",
            "2", "float64", "int",
            "2", "float64", "float64"); !ok {
            return nil, err
        }
    ...
    stdlib["prec"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("prec", args, 1,
            "2", "bignumber", "number"); !ok {
            return nil, err
        }
    ...
    stdlib["abs"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
    ...
    stdlib["round"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("round", args, 2, "1", "float64", "1", "int"); !ok {
            return nil, err
        }
        switch args[0].(type) {
        case float64:
    ...
    stdlib["floor"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("floor", args, 2, "1", "float64", "1", "int"); !ok {
            return nil, err
        }
        switch args[0].(type) {
        case float64:
    ...
    stdlib["ubin8"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("ubin8", args, 1, "1", "string"); !ok {
            return nil, err
        }
    ...
    stdlib["uhex32"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("uhex32", args, 1, "1", "string"); !ok {
            return nil, err
        }
    ...
    stdlib["ibase"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("ibase", args, 1, "2", "number", "number"); !ok {
            return nil, err
        }
        var i int64
        var n int
    ...
    stdlib["rand"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("rand", args, 1, "1", "int"); !ok {
            return nil, err
        }
        if args[0].(int) <= 0 {
    ...
    slhelp["matmul"] = LibHelp{in: "matrix_a, matrix_b", out: "matrix", action: "Perform classic matrix multiplication on two 2‑D arrays."}
    stdlib["matmul"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("matmul", args, 2, "2", "any", "any"); !ok {
            return nil, err
        }

        // Convert to 2-D slices and validate using TypeOf
        a, b := args[0], args[1]

        // Handle case where arrays are []interface{} (each element is a row)
        var matrixA, matrixB [][]any
        if sliceA, okA := a.([]interface{}); okA {
            // Convert []interface{} to [][]interface{}
            matrixA = make([][]any, len(sliceA))
        ...
        // Use TypeOf for more reliable type checking
        if reflect.TypeOf(matrixA).Kind() != reflect.Slice || reflect.TypeOf(matrixB).Kind() != reflect.Slice {
            return nil, errors.New("matmul: both arguments must be 2-D arrays")
        }

        // Check if we have 2-D arrays (not 1-D or 3-D+)
        if len(matrixA) == 0 || len(matrixB) == 0 {
            return nil, errors.New("matmul: empty matrices not allowed")
        }
        ...
        if colsA != rowsB {
            return nil, errors.New(sf("matmul: inner dimensions do not match (%d vs %d)", colsA, rowsB))
        }

        // Validate all rows have consistent column counts
        for i := 0; i < rowsA; i++ {
            if len(matrixA[i]) != colsA {
                return nil, errors.New("matmul: first matrix has inconsistent row lengths")
            }
        }
        for i := 0; i < rowsB; i++ {
            if len(matrixB[i]) != colsB {
                return nil, errors.New("matmul: second matrix has inconsistent row lengths")
            }
        }
        ...
        for i := 0; i < rowsA; i++ {
            for j := 0; j < colsB; j++ {
                sum := 0.0
                for k := 0; k < colsA; k++ {
                    aVal, _ := GetAsFloat(matrixA[i][k])
                    bVal, _ := GetAsFloat(matrixB[k][j])
                    sum += aVal * bVal
                }
                result[i][j] = sum
            }
    ...
    slhelp["dot"] = LibHelp{in: "a, b", out: "scalar_or_vector", action: "Compute inner product (dot product) of vectors or matrices."}
    stdlib["dot"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("dot", args, 2, "2", "any", "any"); !ok {
            return nil, err
        }
        ...
        if ra.Kind() != reflect.Slice || rb.Kind() != reflect.Slice {
            return nil, errors.New("dot: both arguments must be arrays")
        }

        // Determine dimensions
        dimsA := getSliceDimensions(a)
        dimsB := getSliceDimensions(b)

        // Vector · Vector → scalar
        if len(dimsA) == 1 && len(dimsB) == 1 {
            if dimsA[0] != dimsB[0] {
            ...
            for i := 0; i < dimsA[0]; i++ {
                ...
                bVal, _ := GetAsFloat(rb.Index(i).Interface())
                sum += aVal * bVal
            }
            return sum, nil
        }
        ...
        if len(dimsA) == 2 && len(dimsB) == 1 {
            if dimsA[1] != dimsB[0] {
                return nil, errors.New("dot: matrix columns must match vector length")
            }
            result := make([]float64, dimsA[0])
            for i := 0; i < dimsA[0]; i++ {
                sum := 0.0
                for j := 0; j < dimsA[1]; j++ {
                    aVal, _ := GetAsFloat(ra.Index(i).Index(j).Interface())
                    bVal, _ := GetAsFloat(rb.Index(j).Interface())
                    sum += aVal * bVal
                }
                result[i] = sum
            }
        ...
        // Vector · Matrix → vector (less common but supported)
        if len(dimsA) == 1 && len(dimsB) == 2 {
            if dimsA[0] != dimsB[0] {
                return nil, errors.New("dot: vector length must match matrix rows")
            }
            result := make([]float64, dimsB[1])
            for j := 0; j < dimsB[1]; j++ {
                sum := 0.0
                for i := 0; i < dimsA[0]; i++ {
                    aVal, _ := GetAsFloat(ra.Index(i).Interface())
                    bVal, _ := GetAsFloat(rb.Index(i).Index(j).Interface())
                    sum += aVal * bVal
                }
                result[j] = sum
            }
        ...
        // Matrix · Matrix → scalar (flattened inner product)
        if len(dimsA) == 2 && len(dimsB) == 2 {
            if dimsA[0] != dimsB[0] || dimsA[1] != dimsB[1] {
                return nil, errors.New("dot: matrices must have same dimensions for flattened inner product")
            }
            sum := 0.0
            for i := 0; i < dimsA[0]; i++ {
                for j := 0; j < dimsA[1]; j++ {
        ...
        return nil, errors.New("dot: unsupported operand dimensions")
    }

    slhelp["transpose"] = LibHelp{in: "matrix", out: "matrix", action: "Transpose a 2‑D matrix (swap rows and columns)."}
    stdlib["transpose"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        if ok, err := expect_args("transpose", args, 1, "1", "any"); !ok {
            return nil, err
        }

        a := args[0]

        // Handle case where array is []interface{} (each element is a row)
        var matrix [][]any
        if slice, ok := a.([]interface{}); ok {
            // Convert []interface{} to [][]interface{}
            matrix = make([][]any, len(slice))
        ...
        if reflect.TypeOf(matrix).Kind() != reflect.Slice {
            return nil, errors.New("transpose: argument must be a 2-D array")
        }
        ...
        for i := 0; i < rows; i++ {
            if len(matrix[i]) != cols {
                return nil, errors.New("transpose: matrix has inconsistent row lengths")
            }
        }
...
// prod_multi handles multi-dimensional arrays by flattening them and computing product
func prod_multi(v any) float64 {
    if !isSlice(v) {
        // Handle scalar case
        f, hasError := GetAsFloat(v)
        if hasError {
    ...
    if len(dims) == 1 {
        ...
        switch v.(type) {
        case []int:
            return float64(prod_int(v.([]int)))
        case []int64:
            return float64(prod_int64(v.([]int64)))
        case []uint:
            return float64(prod_uint(v.([]uint)))
        case []float64:
            return prod_float64(v.([]float64))
        case []any:
            // Check if this is actually a multi-dimensional array
            anySlice := v.([]any)
            if len(anySlice) > 0 && isSlice(anySlice[0]) {
                // Multi-dimensional array - flatten and compute
                flat := flattenSlice(v)
                return prod_inter(flat)
            } else {
                // True 1D []any slice
                return prod_inter(anySlice)
            }
        default:
            // For other types, try to convert to float64
            flat := flattenSlice(v)
...
func prod_int64(nums []int64) int64 {
    result := int64(1)
    for _, num := range nums {
        result *= num
    }
...
func prod_float64(nums []float64) float64 {
    result := 1.0
    for _, num := range nums {
        result *= num
    }
...
func prod_inter(nums []any) float64 {
    result := 1.0
    for _, num := range nums {
        f, hasError := GetAsFloat(num)
        if hasError {
            return math.NaN()
        }
        result *= f
