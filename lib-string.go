...
func buildStringLib() {
	...
	categories["string"] = []string{"pad", "field", "fields", "get_value", "has_start", "has_end", "match", "filter",
		...
		"next_match", "line_add", "line_delete", "line_replace", "line_add_before", "line_add_after", "line_match", "line_filter", "grep", "sgrep", "line_head", "line_tail", "is_utf8",
	...
	stdlib["replace"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("replace", args, 1, "3", "string", "string", "string"); !ok {
			return nil, err
		}
	...
	stdlib["ccformat"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if len(args) == 0 {
			return "", errors.New("Bad arguments (count) in ccformat()")
		}
		if sf("%T", args[0]) != "string" {
			return "", errors.New("Bad arguments (type) (arg #1 not string) in ccformat()")
		}
		if len(args) == 1 {
	...
	stdlib["format"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if len(args) == 0 {
			return "", errors.New("Bad arguments (count) in format()")
		}
		if !strcmp(sf("%T", args[0]), "string") {
			return "", errors.New("Bad arguments (type) (first argument is not a string) in format()")
		}
		if len(args) == 1 {
	...
	stdlib["pos"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("pos", args, 1, "2", "int", "int"); !ok {
			return nil, err
		}
	...
	stdlib["bg256"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("bg256", args, 1, "1", "number"); !ok {
			return nil, err
		}
		i, _ := GetAsInt(args[0])
		if ansiMode {
	...
	stdlib["fg256"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("fg256", args, 1, "1", "number"); !ok {
			return nil, err
		}
		i, _ := GetAsInt(args[0])
		if ansiMode {
	...
	stdlib["bgrgb"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("bgrgb", args, 1, "3", "number", "number", "number"); !ok {
			return nil, err
		}
		r, _ := GetAsInt(args[0])
		g, _ := GetAsInt(args[1])
	...
	stdlib["fgrgb"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("fgrgb", args, 1, "3", "number", "number", "number"); !ok {
			return nil, err
		}
		r, _ := GetAsInt(args[0])
		g, _ := GetAsInt(args[1])
	...
	stdlib["addansi"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("addansi", args, 1, "1", "string"); !ok {
			return nil, err
		}
		return sparkle(args[0].(string)), nil
	}
	...
	stdlib["stripansi"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("stripansi", args, 1, "1", "string"); !ok {
			return nil, err
		}
	...
	stdlib["stripcc"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("stripcc", args, 1, "1", "string"); !ok {
			return nil, err
		}
	...
	slhelp["log_sanitise"] = LibHelp{in: "string", out: "string", action: "Redact sensitive information from a string for logging purposes. Detects and redacts passwords, API keys, tokens, and other sensitive data."}
	stdlib["log_sanitise"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("log_sanitise", args, 1, "1", "string"); !ok {
			return nil, err
		}
	...
	stdlib["sanitisation"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		...
		if len(args) == 0 {
			return permit_sanitisation, nil
		}
		if enabled, ok := args[0].(bool); ok {
			permit_sanitisation = enabled
			return enabled, nil
		}
		return permit_sanitisation, nil
	}
	...
	stdlib["rvalid"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("rvalid", args, 1, "1", "string"); !ok {
			return nil, err
		}
	...
	stdlib["lower"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("lower", args, 1, "1", "string"); !ok {
			return nil, err
		}
	...
	stdlib["upper"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("upper", args, 1, "1", "string"); !ok {
			return nil, err
		}
	...
	stdlib["line_add"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_add", args, 1, "2", "string", "string"); !ok {
			return nil, err
		}
	...
	stdlib["line_add_before"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_add_before", args, 1, "3", "string", "string", "string"); !ok {
			return nil, err
		}
	...
	stdlib["line_add_after"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_add_after", args, 1, "3", "string", "string", "string"); !ok {
			return nil, err
		}
	...
	stdlib["line_delete"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_delete", args, 1, "2", "string", "string"); !ok {
			return nil, err
		}
	...
	stdlib["line_replace"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_replace", args, 1, "3", "string", "string", "string"); !ok {
			return nil, err
		}
	...
	stdlib["collapse"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("collapse", args, 1, "1", "string"); !ok {
			return "", err
		}
	...
	stdlib["inset"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("inset", args, 1, "2", "string", "int"); !ok {
			return "", err
		}
		s := args[0].(string)
		dist := args[1].(int)
	...
	stdlib["line_head"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_head", args, 1, "2", "string", "int"); !ok {
			return "", err
		}
	...
	stdlib["line_tail"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_tail", args, 1, "2", "string", "int"); !ok {
			return "", err
		}
	...
	stdlib["line_match"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_match", args, 1, "2", "string", "string"); !ok {
			return "", err
		}
	...
	stdlib["next_match"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("next_match", args, 1, "3", "string", "string", "int"); !ok {
			return "", err
		}
	...
	stdlib["grep"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		return stdlib["line_filter"](ns, evalfs, ident, args...)
	}
	...
	stdlib["line_filter"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("line_filter", args, 1, "2", "string", "string"); !ok {
			return "", err
		}
		...
		for _, v := range list {
			if m, _ := regexp.MatchString(reg, v); m {
				newstring.WriteString(v + lsep)
			}
		}

		// trim right-most newline from replacement
		repl := newstring.String()
		if len(repl) > 0 {
			if repl[len(repl)-1] == '\n' {
				repl = repl[:len(repl)-1]
			}
	...
	stdlib["sgrep"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		...
		// Extract and validate required .regex parameter
		regexInterface, hasRegex := options["regex"]
		if !hasRegex {
			return nil, fmt.Errorf("sgrep() requires .regex parameter in options map")
		}
		regex, ok := regexInterface.(string)
		if !ok {
			return nil, fmt.Errorf("sgrep() .regex parameter must be a string")
		}
		...
		if beforeInterface, hasBefore := options["before"]; hasBefore {
			if beforeVal, ok := beforeInterface.(int); ok && beforeVal >= 0 {
				...
				return nil, fmt.Errorf("sgrep() .before parameter must be a non-negative integer")
			}
		}

		if afterInterface, hasAfter := options["after"]; hasAfter {
			if afterVal, ok := afterInterface.(int); ok && afterVal >= 0 {
				after = afterVal
			} else {
				return nil, fmt.Errorf("sgrep() .after parameter must be a non-negative integer")
			}
		}

		if numberInterface, hasNumber := options["number"]; hasNumber {
			if numberVal, ok := numberInterface.(bool); ok {
				number = numberVal
			} else {
				return nil, fmt.Errorf("sgrep() .number parameter must be a boolean")
			}
		}
		...
		if err != nil {
			return nil, fmt.Errorf("sgrep() failed to read file '%s': %v", filename, err)
		}

		// Split into lines with line numbers
		var lines []string
		if runtime.GOOS != "windows" {
			lines = str.Split(string(fileContent), "\n")
		} else {
			lines = str.Split(str.Replace(string(fileContent), "\r\n", "\n", -1), "\n")
		}
	...
	stdlib["match"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("match", args, 1, "2", "string", "string"); !ok {
			return "", err
		}
	...
	stdlib["filter"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("filter", args, 2,
			"2", "string", "string",
			"3", "string", "string", "int"); !ok {
			return "", err
		}
	...
	stdlib["substr"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("substr", args, 1, "3", "string", "int", "int"); !ok {
			return "", err
		}
	...
	stdlib["strpos"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
	...
	stdlib["gsub"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("gsub", args, 1, "3", "string", "string", "string"); !ok {
			return "", err
		}
	...
	stdlib["trim"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
	...
	stdlib["has_start"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("has_start", args, 1, "2", "string", "string"); !ok {
			return "", err
		}
	...
	stdlib["has_end"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("has_end", args, 1, "2", "string", "string"); !ok {
			return "", err
		}
	...
	slhelp["levdist"] = LibHelp{in: "string,string", out: "int", action: "Calculate Levenshtein edit distance between two strings."}
	stdlib["levdist"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
		if ok, err := expect_args("levdist", args, 1, "2", "string", "string"); !ok {
			return nil, err
		}
		s1 := args[0].(string)
		s2 := args[1].(string)
