...
func buildHtmlLib() {
	...
	stdlib["wimg"] = func(evalfs uint32,args ...interface{}) (ret interface{}, err error) {
        if ok,err:=expect_args("wimg",args,3,"2","string","any","1","string","0"); !ok { return nil,err }
        var o string
	...
	stdlib["wlink"] = func(evalfs uint32,args ...interface{}) (ret interface{}, err error) {
        if ok,err:=expect_args("wlink",args,3,"2","string","any","1","string","0"); !ok { return nil,err }
        var o string
        o,err=parseHtmlArgs(args[0])
        if err!=nil { return "",err }
        return "<link "+o+">\n",nil
