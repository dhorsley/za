...
func (p *leparser) list_filter(left any, right any) any {
    ...
    if leftType.Kind() == reflect.Slice {
        ...
        for i := 0; i < sliceLen; i++ {
            ...
            if str.Contains(newRight, "#[") && isContainerType(element) {
                var err error
    ...
    if leftType.Kind() == reflect.Map {
        ...
        for iter.Next() {
            ...
            if str.Contains(newRight, "#[") && isContainerType(value) {
                var err error
...
func (p *leparser) list_map(left any, right any) any {
    ...
    if leftType.Kind() == reflect.Slice {
        ...
        // Handle #[index] patterns if element is a slice
        if str.Contains(newRight, "#[") && isContainerType(firstElement) {
            var err error
