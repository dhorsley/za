...
func buildListLib() {
	...
	stdlib["head"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
			return nil, errors.New("Bad args (count) to head()")
		}
		switch args[0].(type) {
		case []bool:
			if len(args[0].([]bool)) == 0 {
	...
	stdlib["tail"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
			return nil, errors.New("Bad args (count) to tail()")
		}
		switch args[0].(type) {
		case []bool:
			if len(args[0].([]bool)) == 0 {
	...
	stdlib["all"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) == 0 {
			return false, errors.New("no list provided to all().")
		}
		switch args[0].(type) {
		case []bool:
	...
	stdlib["any"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) == 0 {
			return false, errors.New("no list provided to any().")
		}
		switch args[0].(type) {
		case []bool:
			for _, v := range args[0].([]bool) {
	...
	stdlib["fieldsort"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		...
		if len(args) == 0 || len(args) > 4 {
			return nil, errors.New("Bad args (count) to fieldsort()")
		}
		...
		ns.Grow(100)
		for _, l := range list {
			ns.WriteString(str.Join(l, " ") + lsep)
		}
	...
	stdlib["sort"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) == 0 || len(args) > 2 {
			return nil, errors.New("Bad args (count) to sort()")
		}
	...
	stdlib["list_float"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
			return nil, errors.New("Bad args (count) to list_float()")
		}
	...
	stdlib["list_int"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
			return nil, errors.New("Bad args (count) to list_int()")
		}
		var int_list []int
		switch args[0].(type) {
		case []interface{}:
	...
	stdlib["uniq"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		...
		if len(args) != 1 {
			return nil, errors.New("Bad arguments (count) in uniq()")
		}
		if args[0] == nil {
			return nil, errors.New("Bad arguments (type) in uniq()")
		}
	...
	stdlib["min"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
			return 0, errors.New("Bad args (count) to min()")
		}
		switch args[0].(type) {
		case []interface{}:
	...
	stdlib["max"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
			return 0, errors.New("Bad args (count) to max()")
		}
		switch args[0].(type) {
		case []interface{}:
	...
	stdlib["avg"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
			return 0, errors.New("Bad args (count) to avg()")
		}
		var f float64
		switch args[0].(type) {
		case []interface{}:
	...
	stdlib["sum"] = func(evalfs uint64, args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
			return nil, errors.New("Bad args (count) to sum()")
		}
		var f float64
		switch args[0].(type) {
		case []interface{}:
