...
func GetWatcherField(obj interface{},fieldname string) interface{} {
...
func buildNotifyLib() {
    ...
    stdlib["ev_watch_add"] = func(evalfs uint32,ident *[szIdent]Variable,args ...interface{}) (ret interface{}, err error) {
    ...
    stdlib["ev_event"] = func(evalfs uint32,ident *[szIdent]Variable,args ...interface{}) (ret interface{}, err error) {
        ...
        select {
            case event, ok = <-id.Events:
                if !ok { return 0,errors.New("Could not read events in ev_event") }
    ...
    stdlib["ev_mask"] = func(evalfs uint32,ident *[szIdent]Variable,args ...interface{}) (ret interface{}, err error) {
