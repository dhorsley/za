...
func buildDateLib() {
	...
	stdlib["date"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["date_human"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["epoch_time"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_hours"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_minutes"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_seconds"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_nanos"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_dow"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_dom"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_month"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_year"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["epoch_nano_time"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
	...
	stdlib["time_diff"] = func(evalfs uint32,ident *[]Variable,args ...interface{}) (ret interface{}, err error) {
