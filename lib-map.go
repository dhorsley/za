...
func buildMapLib() {
    features["map"] = Feature{version: 1, category: "data"}
    categories["map"] = []string{"merge", "intersect", "difference", "symmetric_difference"}
    ...
    stdlib["difference"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        ...
        return lib_difference(args), nil
    }
    ...
    stdlib["symmetric_difference"] = func(ns string, evalfs uint32, ident *[]Variable, args ...any) (ret any, err error) {
        ...
        return lib_symmetric_difference(args), nil
    }
}
