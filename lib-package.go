...
func buildPackageLib() {
	...
	stdlib["install"] = func(args ...interface{}) (ret interface{}, err error) {
		if len(args) != 1 {
	...
	stdlib["vcmp"] = func(args ...interface{}) (ret interface{}, err error) {
		if len(args) != 2 {
	...
	stdlib["service"] = func(args ...interface{}) (ret interface{}, err error) {
