...
func limitNumClients(f http.HandlerFunc, maxClients int, evalfs uint32, ident *[szIdent]Variable) http.HandlerFunc {
    sema := make(chan struct{}, maxClients)
    return func(w http.ResponseWriter, req *http.Request) {
        ctx:=req.Context()
        ctx=context.WithValue(ctx,"evalfs",evalfs)
        // ctx=context.WithValue(ctx,"evalident",ident)
...
func webRouter(w http.ResponseWriter, r *http.Request) {
    ...
    // evalident,_:=r.Context().Value("evalident").(*[szIdent]Variable)
...
func buildNetLib() {
    ...
    stdlib["net_interfaces"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_display"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_max_clients"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_log"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_decode"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_start"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_stop"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["html_escape"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["html_unescape"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_up"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_path"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_log_throttle"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
...
//  than the few seconds I've considered it for.
    ...
    stdlib["web_template"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
...
*/
    ...
    stdlib["web_head"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_get"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_custom"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
        ...
        switch len(args) {
        case 3:
            for k,v:=range args[2].(map[string]any) { headers[k]=v.(string) }
        }

        // headers
        request, err := http.NewRequest(method_string, loc_string, nil)
        if err != nil { return []any{"Could not create a new HTTP request in web_custom()",nil,400},nil }
    ...
    stdlib["web_post"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["download"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_download"] = func(evalfs uint32,ident *[szIdent]Variable,args ...any) (ret any, err error) {
