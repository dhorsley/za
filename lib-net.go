    ...
    for _,rule := range wr_copy {
        ...
        case "f":
            ...
            if re.MatchString(path) {
                ...
                rcount,_:=Call(MODE_NEW, &ident, loc, ciLnet, self_s{}, []string{}, webcallstruct)
                atomic.AddInt32(&concurrent_funcs,-1)
...
func buildNetLib() {
    ...
    stdlib["net_interfaces"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_display"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_max_clients"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_log"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_decode"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_start"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_stop"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["html_escape"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["html_unescape"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_up"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_path"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_serve_log_throttle"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
...
//  than the few seconds I've considered it for.
    ...
    stdlib["web_template"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
...
*/
    ...
    stdlib["web_head"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_get"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_custom"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_post"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["download"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
    ...
    stdlib["web_download"] = func(evalfs uint32,ident *[]Variable,args ...any) (ret any, err error) {
