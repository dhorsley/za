...
func buildErrorLib() {
    ...
    slhelp["error_style"] = LibHelp{in: "mode_string", out: "string", action:
            "Set error handling style mode and return previous mode. panic: standard error handling (default)\n"+
            "[#SOL]exception: convert normal errors to exceptions / mixed: both panic and exception handling",
    }
