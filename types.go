...
// ExceptionThrow type to distinguish exception throws from regular panics
type ExceptionThrow struct {
    Category any    // Exception category (string or enum value)
    Message  string // Exception message
}

func (e ExceptionThrow) Error() string {
    return e.Message
}

// Global error style state
var (
...
type MutableArg struct {
    ...
    IsGlobal           bool         // Whether this references a global variable
    ...
    IsAutoAllocated    bool         // Whether memory was auto-allocated for koutparam
}
