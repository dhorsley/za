...
syntax match internal_functions "\s*key_press\s*("he=e-1
...
" syntax match image_functions "\s*svg_lineargradient\s*("he=e-1
" syntax match image_functions "\s*svg_radialgradient\s*("he=e-1
...
syntax match statements "\(^\|\s\+\)\(pause\|debug\|print\|println\|break\|endif\|unset\|while\|quiet\|pane\)\($\|\s\+\)"
syntax match statements "\(^\|\s\+\)\(module\|prompt\|return\|define\|endfor\|enddef\|enable\)\($\|\s\+\)"
syntax match statements "\(^\|\s\+\)\(version\|require\|setglob\|showdef\|endwhen\|logging\|subject\|disable\)\($\|\s\+\)"
...
" syn cluster ArithParenList  contains=Arithmetic,Comment,Escape,Number,Operator,SingleQuote,tstatements,statements,Variable,CtrlSeq,Special,Paren,Functions
...
hi colour_b0    ctermbg=black
hi colour_b1    ctermbg=blue
hi colour_b2    ctermbg=red
hi colour_b3    ctermbg=magenta
hi colour_b4    ctermbg=green
hi colour_b5    ctermbg=cyan
hi colour_b6    ctermbg=yellow
hi colour_b7    ctermbg=gray ctermfg=black

hi colour_f0    ctermfg=black ctermbg=gray
hi colour_f1    ctermfg=blue ctermbg=gray
hi colour_f2    ctermfg=red ctermbg=gray
hi colour_f3    ctermfg=magenta ctermbg=gray
hi colour_f4    ctermfg=green ctermbg=gray
hi colour_f5    ctermfg=cyan ctermbg=gray
hi colour_f6    ctermfg=yellow ctermbg=gray
hi colour_f7    ctermfg=white ctermbg=gray

hi colour_normal ctermfg=cyan ctermbg=black
