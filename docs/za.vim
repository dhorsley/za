...
syntax match list_functions "\(^|.\|\s*\)list_float32\s*("he=e-1
syntax match list_functions "\(^|.\|\s*\)list_int16\s*("he=e-1
syntax match list_functions "\(^|.\|\s*\)list_int32\s*("he=e-1
syntax match list_functions "\(^|.\|\s*\)list_int8\s*("he=e-1
syntax match list_functions "\(^|.\|\s*\)list_uint16\s*("he=e-1
syntax match list_functions "\(^|.\|\s*\)list_uint32\s*("he=e-1
syntax match list_functions "\(^|.\|\s*\)list_uint64\s*("he=e-1
syntax match list_functions "\(^|.\|\s*\)list_uint8\s*("he=e-1
...
syntax match internal_functions "\(^|.\|\s*\)feed\s*("he=e-1
...
syntax match internal_functions "\(^|.\|\s*\)term\s*("he=e-1
...
syntax match internal_functions "\(^|.\|\s*\)gdump\s*("he=e-1
syntax match internal_functions "\(^|.\|\s*\)mdump\s*("he=e-1
...
syntax match tui_functions "\(^|.\|\s*\)tui_table_select\s*("he=e-1
...
syntax match math_functions "\(^|.\|\s*\)atan2\s*("he=e-1
syntax match math_functions "\(^|.\|\s*\)randf32\s*("he=e-1
...
syntax match web_functions "\(^|.\|\s*\)web_display\s*("he=e-1
...
syntax match web_functions "\(^|.\|\s*\)web_serve_log\s*("he=e-1
...
syntax match string_functions "\(^|.\|\s*\)trunc\s*("he=e-1
syntax match string_functions "\(^|.\|\s*\)progress_bar\s*("he=e-1
...
syntax match string_functions "\(^|.\|\s*\)bg256\s*("he=e-1
syntax match string_functions "\(^|.\|\s*\)fg256\s*("he=e-1
syntax match string_functions "\(^|.\|\s*\)bgrgb\s*("he=e-1
syntax match string_functions "\(^|.\|\s*\)fgrgb\s*("he=e-1
...
syntax match os_functions "\(^|.\|\s*\)groupname\s*("he=e-1
syntax match os_functions "\(^|.\|\s*\)username\s*("he=e-1
...
syntax match notify_functions "\(^|.\|\s*\)ev_watch_remove\s*("he=e-1
...
syntax match sum_functions "\(^|.\|\s*\)md5sum\s*("he=e-1
syntax match sum_functions "\(^|.\|\s*\)sha1sum\s*("he=e-1
...
syntax match unsorted_functions "\(^|.\|\s*\)ssl_cert_install_help\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)iodiff\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)disk_usage\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)netstat_established\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)squeeze\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)exreg\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)tcp_receive\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)concatenate\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)ps_info\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_style\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)std\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_gzip_enable\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_extract_addresses\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)list_int64\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_emergency_exit\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)dot\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)det_big\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)gw_interface\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)group_info\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)intersect\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)log_exception_with_stack\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_source_location\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)group_del\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)inverse\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)resource_usage\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)gw_info\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)tcp_available\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)inverse_big\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)open_files\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)net_devices\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_cache_max_memory\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)det\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)format_date\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)where\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)log_exception\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)merge\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)cron_parse\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)symmetric_difference\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)icmp_ping\s*("he=e-1
...
syntax match unsorted_functions "\(^|.\|\s*\)quartz_to_cron\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_cache_enable\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)sys_load\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)matmul\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)ps_tree\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)group_membership\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_global_variables\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)netstat_protocols\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)netstat_protocol\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)has_privileges\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)identity\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_cache_max_age\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_cache_cleanup_interval\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)debug_cpu_files\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)rank\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)mean\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_remove_header\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)network_stats\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_extend\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_source_context\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)gw_address\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)flatten\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)mount_info\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_message\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)cmd_version\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)port_scan\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_cache_stats\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)ps_list\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)cron_validate\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)tcp_ping\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_source_line_numbers\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_cache_max_size\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)netstat_process\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)mem_info\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)cron_next\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)anytrue\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)array_colours\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_base64_decode\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_validate\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_raw_send\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)logging_stats\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)group_add\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)smtp_send_with_auth\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)is_utf8\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)log_sanitise\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)http_benchmark\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)literal\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)dns_resolve\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)is_superset\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)format_time\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)argmin\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)rlen\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)difference\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)smtp_send\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)variance\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)netstat_protocol_info\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_call_chain\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)zeros\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)tcp_client\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)prod\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)is_disjoint\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)find\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)median\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)transpose\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)log_queue_status\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)netstat_interface\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)web_cache_purge\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)smtp_send_with_attachments\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)group_mod\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)ps_map\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_get_attachments\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_add_header\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_parse_headers\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_base64_encode\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)email_process_template\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)netstat_listen\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)net_interfaces_detailed\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)icmp_traceroute\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)tcp_send\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)ones\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)cpu_info\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)reshape\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)alltrue\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)format_stack_trace\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_filename\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)error_call_stack\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)exception_strictness\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)http_headers\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)netstat\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)argmax\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)group_list\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)keys\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)powershell_version\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)panic\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)stack\s*("he=e-1
...
syntax match unsorted_functions "\(^|.\|\s*\)lock_os_thread\s*("he=e-1
syntax match unsorted_functions "\(^|.\|\s*\)unlock_os_thread\s*("he=e-1
...
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_float32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_float64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_float32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_float64\s*("he=e-1
...
syntax match c_functions "\(^|.\|\s*\)c_alloc_bytes\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_alloc_int16s\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_alloc_int32s\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_alloc_int64s\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_alloc_int8s\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_alloc_uint16s\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_alloc_uint32s\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_alloc_uint64s\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_alloc_uint8s\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_int16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_int32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_int64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_int8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_uint16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_uint32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_uint64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_get_uint8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_int16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_int32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_int64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_int8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_uint16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_uint32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_uint64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_bulk_set_uint8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_float32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_float64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_int16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_int32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_int64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_int8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_uint16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_uint32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_uint64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_from_c_uint8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_float32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_float64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_int16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_int32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_int64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_int8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_uint16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_uint32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_uint64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_copy_to_c_uint8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_get_int16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_get_int32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_get_int64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_get_int8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_get_uint16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_get_uint32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_get_uint64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_get_uint8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_set_int16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_set_int32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_set_int64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_set_int8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_set_uint16\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_set_uint32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_set_uint64\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_array_set_uint8\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_get_float32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_get_float32_at_addr\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_set_float32\s*("he=e-1
syntax match c_functions "\(^|.\|\s*\)c_set_float32_at_addr\s*("he=e-1
...
syntax match conversion_functions "\(^|.\|\s*\)as_int16\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)as_int32\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)as_int8\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)as_uint16\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)as_uint32\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)as_uint64\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)as_uint8\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)gzip_compress\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)gzip_compress_bytes\s*("he=e-1
syntax match conversion_functions "\(^|.\|\s*\)gzip_decompress\s*("he=e-1
